...
import { Menu, X, ArrowRight, Mail, MapPin, FileText, CheckSquare, Users, GitBranch, Shield, ExternalLink, Check, Compass, Handshake, Database, Layers, Map, ClipboardCheck } from 'lucide-react';
...
const CareQueryWebsite = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'what-it-does', 'for-your-practice', 'how-it-works', 'join-the-pilot', 'contact'];
  ...
  const navItems = [
    ...
    { id: 'for-your-practice', label: 'For Your Practice' },
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: '#ffffff', minHeight: '100vh', color: '#111827' }}>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '5rem 1.5rem 4rem' }}>
          <div style={{ maxWidth: '700px' }}>
            ...
            <h1 className="heading" style={{ fontSize: 'clamp(2.2rem, 5vw, 3.2rem)', lineHeight: 1.15, color: '#111827', marginBottom: '1.25rem', letterSpacing: '-0.02em' }}>
              ...
              <em style={{ color: '#2563eb' }}>Before you send the referral.</em>
            </h1>
            <p className="body-text" style={{ fontSize: '1.05rem', lineHeight: 1.7, color: '#4b5563', marginBottom: '1.75rem', fontWeight: 400 }}>
              <span className="brand">Care Query</span> gives your whole practice team a clear view of local MSK pathway requirements — so the referral goes right the first time, and the patient leaves with something useful whether they're ready to be referred today or not.
            </p>
            <div style={{ borderLeft: '3px solid #374151', paddingLeft: '1rem', marginBottom: '2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#111827', fontWeight: 400 }}>
                Next time you're about to refer an MSK patient, open <span className="brand">Care Query</span>. The <strong style={{ color: '#ca8a04' }}>Service Card</strong> shows what the service actually does — the criteria, the catchment, the investigations it expects. The <strong style={{ color: '#9b2335' }}>Gate Card</strong> confirms all prerequisites for this patient before you submit. In either outcome — referral ready today, or a step away — the patient leaves the consultation with a URL they can open.
              </p>
              <p className="body-text" style={{ fontSize: '0.88rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                <span className="brand">Care Query</span> encodes local NHS MSK service requirements into a single governed record per service, generating five outputs: a <strong>Pathway Overview</strong> (all services at a glance), a <strong style={{ color: '#ca8a04' }}>Service Card</strong> (what the service does and who it sees), a <strong style={{ color: '#9b2335' }}>Gate Card</strong> (per-patient administrative checklist), a <strong style={{ color: '#16a34a' }}>Journey Card</strong> (patient summary when the referral is submitted and ready), and a <strong style={{ color: '#4f46e5' }}>Preparation Card</strong> (patient plan when prerequisites are still outstanding). All five from a single governed record. When information changes, every output reflects the update.
              </p>
            </div>
            ...
            <p className="body-text" style={{ fontSize: '0.82rem', color: '#6b7280', fontWeight: 400, lineHeight: 1.6 }}>
              Designed by First Contact Practitioners. Built for primary care workflow. No EMIS integration. No patient data. Runs in any browser.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="two-col" style={{ display: 'grid', gridTemplateColumns: '2fr 3fr', gap: '4rem', alignItems: 'start', marginBottom: '3.5rem' }}>
            <div>
              ...
              <h2 className="heading" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', lineHeight: 1.2, color: '#111827', letterSpacing: '-0.01em' }}>
                Five outputs. One governed record. Zero integration needed.
              </h2>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem' }}>
              <p className="body-text" style={{ fontSize: '0.95rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                Every output is generated from a single structured service record. When the service changes its criteria, every card updates with it.
              </p>
              <p className="body-text" style={{ fontSize: '0.95rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                The <strong>Pathway Overview</strong> gives you the landscape. The <strong style={{ color: '#ca8a04' }}>Service Card</strong> shows you what each service actually does. The <strong style={{ color: '#9b2335' }}>Gate Card</strong> confirms prerequisites before submission. The <strong style={{ color: '#16a34a' }}>Journey Card</strong> goes to the patient when the referral is submitted and ready. The <strong style={{ color: '#4f46e5' }}>Preparation Card</strong> goes to the patient when prerequisites are still outstanding — turning "not yet" into a structured next step. All five from the same governed record.
              </p>
            </div>
          </div>
          ...
          {[
            {
              ...
              borderColor: '#2563eb',
              defaultOpen: false,
              summary: 'All local MSK services on one screen in under 30 seconds. The starting point.',
              detail: (
                <>
            ...
            },
            {
              ...
              borderColor: '#ca8a04',
              defaultOpen: true,
              summary: 'What the service actually does, who it sees, and what it needs before entry. The question you currently answer by sending a trial referral — answered here first.',
              detail: (
                <>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
            ...
            },
            {
              ...
              borderColor: '#9b2335',
              defaultOpen: false,
              summary: 'Each prerequisite confirmed individually. If a criterion cannot be met because the service does not exist locally, use the Cannot Meet option to formally document the system barrier — not just leave it blank.',
              detail: (
                <>
            ...
            },
            {
              ...
              borderColor: '#16a34a',
              defaultOpen: false,
              summary: "Sent to the patient via SMS after referral. They know where they're going, what happens next, and what to expect. No more 'what did the doctor say?' callback.",
              detail: (
                <>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
            ...
            },
            {
              ...
              borderColor: '#4f46e5',
              defaultOpen: false,
              summary: 'For patients not yet ready to refer. They leave with a clear plan — what remains outstanding, what they can do now, when to review. The consultation closes cleanly.',
              detail: (
                <>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '1.25rem' }}>
                {[
                  ...
                  { label: 'Next milestone', value: 'Pilot with 5–10 GP practices — measure administrative return rate' },
              ...
              {scopeOpen && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', borderLeft: '3px solid #d1d5db', paddingLeft: '1.25rem' }}>
                  ...
                  <p className="body-text" style={{ fontSize: '0.88rem', lineHeight: 1.7, color: '#111827', fontWeight: 400 }}>
                    <strong>Why Cheshire and Merseyside first:</strong> C&amp;M ICB is under NHS England performance management, the Health Innovation North West Coast infrastructure is directly accessible, and the April 2026 A&G mandate creates immediate, measurable pressure on every practice in the footprint.
                  </p>
                </div>
              )}
            </div>
      ...
      {/* For Your Practice */}
      <section id="for-your-practice" style={{ padding: '6rem 1.5rem', background: '#ffffff' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ marginBottom: '3.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              <Users size={20} color="#2563eb" />
              <span className="tag tag-blue" style={{ marginBottom: '0' }}>Practice Team</span>
            </div>
            <h2 className="heading" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', lineHeight: 1.2, color: '#111827', marginBottom: '1rem', letterSpacing: '-0.01em' }}>
              Useful across the whole practice team.
            </h2>
            <p className="body-text" style={{ fontSize: '0.95rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
              Different roles. Same tool. Different reasons it saves time.
            </p>
          </div>
          ...
          {[
            {
              ...
              title: 'GP Partners & Clinicians',
              tagClass: 'tag-blue',
              tagLabel: 'For GPs',
              borderColor: '#2563eb',
              defaultOpen: true,
              summary: 'Fewer returns. Cleaner sign-off. Something in the patient\'s hand.',
              detail: (
                <>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    You've decided where this patient needs to go. Care Query shows you what the service needs before you submit — so you're not learning by rejection.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    If a prerequisite can't be met because the local service is defunded or overloaded, the Cannot Meet option formally documents the system barrier. That's a contemporaneous record that shows you were aware of the criterion and documents why the system couldn't deliver it — not a gap in your notes.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                    Either way — referral ready or not yet — the patient leaves with a URL they can open. The consultation closes cleanly. The rebook doesn't happen.
                  </p>
                </>
              ),
            },
            {
              ...
              title: 'FCPs and Advanced Practitioners',
              tagClass: 'tag-green',
              tagLabel: 'For FCPs',
              borderColor: '#16a34a',
              defaultOpen: false,
              summary: 'Your assessment. Clean GP handoff. No trial-and-error referrals.',
              detail: (
                <>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    You've assessed the patient and know where they need to go. Care Query's Gate Card generates a structured clipboard summary you hand to the GP for sign-off — not a handwritten note they need to rebuild from scratch.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    The Service Card shows you what the receiving service actually does, so you're not routing patients to services that won't accept them.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                    The patient leaves your assessment with a plan whether the referral is submitted today or not.
                  </p>
                </>
              ),
            },
            {
              icon: <Layers size={20} color="#ca8a04" />,
              title: 'Practice Managers',
              tagClass: 'tag-amber',
              tagLabel: 'For Practice Managers',
              borderColor: '#ca8a04',
              defaultOpen: false,
              summary: 'No IT headaches. No IG nightmares. Fewer admin loops.',
              detail: (
                <>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    Care Query runs in a browser. No EMIS or SystmOne API integration. No software installation. No Information Governance approval process to set up. You can start using it in five minutes.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    Rotating locums and ARRS clinicians don't have the institutional knowledge of your specific local MSK pathways. Care Query acts as a local cheat sheet — every locum refers with the same information a Senior Partner carries in their head.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                    Returned referrals create avoidable admin loops. Medical secretaries spend time chasing GPs for information that should have been included at submission. Care Query catches those gaps before the referral is sent.
                  </p>
                </>
              ),
            },
            {
              icon: <Handshake size={20} color="#6b7280" />,
              title: 'Admin and Reception',
              tagClass: 'tag-slate',
              tagLabel: 'For Reception & Admin',
              borderColor: '#6b7280',
              defaultOpen: false,
              summary: "Fewer 'where is my referral?' calls. Clearer next steps for patients.",
              detail: (
                <>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    When a patient has been referred, the Journey Card URL gives them a readable summary of where they are going and what to expect. Reception can share this link when patients call asking "what happens next?" — without interrupting a clinician mid-consultation.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                    When a patient isn't yet ready for referral, the Preparation Card explains what still needs to happen and suggests a review date. That reduces follow-up calls to the practice.
                  </p>
                  <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                    Neither card requires the patient to log in or create an account. It is a read-only link — no patient data is collected or stored.
                  </p>
                </>
              ),
            },
      ...
      {/* How It Works */}
      <section id="how-it-works" style={{ padding: '6rem 1.5rem', background: '#f9fafb' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ marginBottom: '3.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              <Layers size={20} color="#2563eb" />
              <span className="tag tag-blue" style={{ marginBottom: '0' }}>Workflow</span>
            </div>
            <h2 className="heading" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', lineHeight: 1.2, color: '#111827', marginBottom: '1rem', letterSpacing: '-0.01em' }}>
              What happens in a real consultation.
            </h2>
            <p className="body-text" style={{ fontSize: '0.95rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
              Four steps. No integration. No setup.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'Open the Service Card',
                body: 'Search the Pathway Overview for the service this patient needs. The Service Card shows what the service does, who it accepts, and what it requires before entry. 30 seconds to understand a pathway you\'d otherwise learn from a rejection.',
              },
              {
                step: '02',
                icon: <CheckSquare size={20} color="#9b2335" />,
                title: 'Complete the Gate Card',
                body: 'Each prerequisite is confirmed individually. You declare how you know each one is met — from the patient record, patient-reported, not yet achievable, or structurally impossible with a documented reason. One click copies the formatted summary to your clipboard.',
              },
              {
                step: '03',
                icon: <ClipboardCheck size={20} color="#374151" />,
                title: 'Paste into e-RS or your A&G submission',
                body: "The clipboard summary includes all gate attestations, a timestamp, and an 'if returned' prompt. Paste it into your EMIS or SystmOne A&G free-text. No integration required.",
              },
              {
                step: '04',
                icon: <Users size={20} color="#16a34a" />,
                title: 'Send the patient link',
                body: 'Copy the Journey Card or Preparation Card URL and send it via AccuRx SMS. The patient has something to open before they leave the car park. You have a clean record of the consultation.',
              },
            ].map((item, i) => (
              <div key={i} className="card" style={{ padding: '1.75rem' }}>
                ...
                <p className="body-text" style={{ fontSize: '0.88rem', lineHeight: 1.65, color: '#4b5563', fontWeight: 400 }}>{item.body}</p>
              </div>
            ))}
          </div>

          {/* Trust Block */}
          <div style={{ background: '#ffffff', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '2rem', marginBottom: '0' }}>
            <h3 className="heading" style={{ fontSize: '1.1rem', color: '#111827', marginBottom: '1.5rem', letterSpacing: '-0.01em' }}>
              Why your practice can trust this.
            </h3>
            <div className="three-col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1.25rem' }}>
              {[
                { label: 'Clinician-led', desc: 'Designed by a practising FCP who submits A&G referrals and sees this problem daily.' },
                { label: 'Deterministic', desc: 'No AI making decisions. Explicit rules, governed data, auditable outputs.' },
                { label: 'Administrative only', desc: 'Not clinical decision support. You make the clinical call. This handles the administrative layer.' },
                { label: 'No patient data', desc: 'Nothing collected, stored, or processed at any point. Runs entirely in your browser.' },
                { label: 'No integration required', desc: 'Opens in any browser tab. No IT ticket, no procurement, no IG approval process.' },
                { label: 'Governed under DCB0129', desc: 'Clinical risk management standard active. Clinical Safety Officer formally assigned.' },
              ].map((item, i) => (
                <div key={i} style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                  <div style={{ width: '20px', height: '20px', borderRadius: '50%', background: '#dcfce7', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '0.1rem' }}>
                    <Check size={12} color="#166534" />
                  </div>
                  <div>
                    <div className="body-text" style={{ fontSize: '0.85rem', fontWeight: 600, color: '#111827', marginBottom: '0.2rem' }}>{item.label}</div>
          ...
          <div className="two-col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {[
                ...
                { icon: <FileText size={18} color="#2563eb" />, label: 'NICE Evidence Standards Framework', status: 'Planned', desc: 'Classified as Tier A system service — administrative information display, not clinical decision support. Standard 15 applies: pilot site statement only, no minimum sample size.' },
                ...
                <div key={i} style={{ display: 'flex', gap: '1rem', padding: '1rem', background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
      ...
      {/* Join the Pilot */}
      <section id="join-the-pilot" style={{ padding: '6rem 1.5rem', background: '#f9fafb' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start', marginBottom: '3rem' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p className="body-text" style={{ fontSize: '0.95rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                A 12-week trial in 5–10 GP practices. No software installation. No complex approval. Just use it for MSK referrals and tell us what you notice.
              </p>
            </div>
          </div>

          <div className="three-col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '2rem', marginBottom: '2.5rem', alignItems: 'start' }}>
            {[
              {
                title: 'GP Practices',
                desc: '5–10 GP practices in Cheshire and Merseyside ICB to use Care Query for MSK referrals during the 12-week pilot period.',
                tag: 'GP Partners · Salaried GPs · Practice teams',
              },
              {
                title: 'Clinical Contributors',
                desc: 'GPs, FCPs, practice managers, service administrators who recognise the referral loop problem in their practice and want to help fix it.',
                tag: 'Any role involved in MSK referrals',
              },
              {
                title: 'MSK Service Owners',
                desc: 'Service owners willing to verify that a Service Card for their department is accurate. An accurate record means fewer inappropriate referrals and fewer admin calls to your team.',
                tag: 'Service managers · Clinical leads',
              },
            ].map((item, i) => (
              <div key={i} className="card" style={{ padding: '1.75rem', display: 'flex', flexDirection: 'column', height: '100%', background: '#ffffff' }}>
                <h3 className="heading" style={{ fontSize: '1.1rem', color: '#111827', marginBottom: '0.5rem', letterSpacing: '-0.01em' }}>{item.title}</h3>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2.5rem', alignItems: 'start' }} className="two-col">
            <div className="card" style={{ padding: '1.75rem', background: '#ffffff' }}>
              ...
              {[
                'Use Care Query for MSK A&G submissions and referrals during the pilot window',
                'Allow us to measure whether administrative return rates change',
            ...
            <div className="card" style={{ padding: '1.75rem', borderLeft: '4px solid #2563eb', background: '#ffffff' }}>
              <h4 className="heading" style={{ fontSize: '0.95rem', color: '#111827', marginBottom: '0.4rem' }}>Register your practice's interest</h4>
              <p className="body-text" style={{ fontSize: '0.82rem', color: '#4b5563', fontWeight: 400, marginBottom: '0.85rem', lineHeight: 1.5 }}>
                Leave your email and we will be in touch about the pilot opening.
              </p>
              {submitted ? (
                ...
                <form name="stay-informed" data-netlify="true" onSubmit={handleEmailSubmit} style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                  ...
                  <button type="submit" className="btn-primary" style={{ padding: '0.55rem 1.25rem', fontSize: '0.82rem' }}>
                    Register interest <ArrowRight size={14} style={{ display: 'inline', marginLeft: '0.2rem', verticalAlign: 'middle' }} />
                  </button>
                </form>
              )}
      ...
      <section id="faq" style={{ padding: '6rem 1.5rem', background: '#ffffff' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ marginBottom: '3rem' }}>
            ...
            <h2 className="heading" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', lineHeight: 1.2, color: '#111827', letterSpacing: '-0.01em' }}>
              Questions your practice will ask.
            </h2>
          </div>
          ...
          {[
            {
              ...
              detail: (
                <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                  No. <span className="brand">Care Query</span> runs in a browser tab. No API, no installation, no IG approval process. Open it alongside your clinical system. Use it. Close it. Nothing is installed on your machine or network.
                </p>
              ),
            },
            {
              title: 'Is this a clinical decision support tool?',
              summary: '',
              detail: (
                <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                  No. <span className="brand">Care Query</span> does not tell you what is clinically wrong with the patient or which pathway to choose. You make the clinical decision. Care Query shows you the administrative requirements to get the patient through the service door — the investigations, the documentation, the pathway criteria. It is an administrative tool, not clinical decision support.
                </p>
              ),
            },
            {
              title: 'Is this only for GPs?',
              summary: '',
              detail: (
                <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                  No. The tool is designed for GPs, FCPs, advanced practitioners, and the practice team. The Service Card and Pathway Overview are useful for any clinician managing MSK referrals. The clipboard output is designed for GP A&G sign-off — but the Service Card is valuable for any clinician deciding where to refer.
                </p>
              ),
            },
            {
              title: 'Can admin or reception staff use parts of it?',
              summary: '',
              detail: (
                <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                  Yes. The Journey Card and Preparation Card links can be shared with reception so they can answer patient "what happens next?" calls without escalating to a clinician. The Pathway Overview is also readable by admin staff for basic patient queries about which service covers their area.
                </p>
              ),
            },
            {
              title: 'What happens if a local service changes its criteria?',
              summary: '',
              detail: (
                <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                  Each service record has a named steward and a review date. When criteria change, the steward updates the record and all five outputs reflect the change automatically. If a record is out of date, an amber warning is shown — you are never silently shown old information. Stale-but-visible is always preferable to hidden.
                </p>
              ),
            },
            {
              title: "What if the patient isn't ready to be referred yet?",
              summary: '',
              detail: (
                <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                  That is a first-class outcome in <span className="brand">Care Query</span>, not a failure state. The Preparation Card shows the patient exactly what remains outstanding and what they can do now. The consultation closes with a plan rather than an open question. The patient leaves with a URL they can open. You have a structured record of what is outstanding.
                </p>
              ),
            },
            {
              title: 'What is the commitment for the pilot?',
              summary: '',
              detail: (
                <p className="body-text" style={{ fontSize: '0.9rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
                  12 weeks. Use <span className="brand">Care Query</span> for MSK referrals during that period. Complete a short post-pilot feedback form. No other obligations. No installation, no procurement, no IT involvement. If it gets in your way, tell us — that feedback is as useful as a glowing review.
                </p>
              ),
            },
          ].map((card, idx) => (
            <ExpandableCard key={idx} card={{ ...card, icon: null, tagClass: 'tag-slate', tagLabel: 'FAQ', borderColor: '#d1d5db', defaultOpen: false }} defaultOpen={false} />
          ))}
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div className="two-col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <div className="body-text" style={{ fontSize: '0.78rem', fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#9ca3af', marginBottom: '0.2rem' }}>Clinical &amp; Pilot Enquiries</div>
            ...
            <div className="card" style={{ padding: '1.75rem', alignSelf: 'start' }}>
              ...
              <p className="body-text" style={{ fontSize: '0.88rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                All development is conducted in personal time, on personal infrastructure, using publicly available service information only. No NHS patient data is collected, stored, or processed at any stage.
              </p>
              <p className="body-text" style={{ fontSize: '0.88rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400, marginBottom: '1rem' }}>
                <span className="brand">Care Query</span> is an independent innovation developed in line with NHS digital standards, including DCB0129 clinical safety. It is not endorsed by, affiliated with, or developed on behalf of any NHS organisation.
              </p>
              <p className="body-text" style={{ fontSize: '0.88rem', lineHeight: 1.7, color: '#4b5563', fontWeight: 400 }}>
